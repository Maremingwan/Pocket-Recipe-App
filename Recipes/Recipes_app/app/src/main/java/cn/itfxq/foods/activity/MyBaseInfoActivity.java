...
public class MyBaseInfoActivity extends AppCompatActivity {
    ...
    TextView mybaseinfo_name,mybaseinfo_email,mybaseinfo_tel,mybaseinfo_taste;
    ...
    private void initView() {
        ...
        mybaseinfo_taste = findViewById(R.id.mybaseinfo_taste);
    }
    private void initData() {
        ...
        mybaseinfo_taste.setText(CommonUtils.getLoginUser(this).getTaste());
    }
}